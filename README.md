...
## How It's Made:
This application is made with React, Formik, MySql, Axios, Bootstrap, Node, & Express.
...
I also learned `Sequelize ORM` Sequelize is a promise-based Object-Relational-Mappers for Node.js and io.js. It supports the dialects PostgreSQL, MySQL, MariaDB, SQLite and MSSQL and features solid transaction support which was perfect for this app. Ever since I learned Formik, I have been using it ever since. 
